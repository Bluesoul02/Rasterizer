...
CFLAGS = -std=c++14 -Wall -O $(CDEBUG) $(INC) -I${HOME}/Documents/minwin/include -I${HOME}/Documents/minwin/src
LDFLAGS = -g -L${HOME}/Documents/minwin/bin -lminwin
...
# Create test_3d
$(BIN_DIR)/test_3d: $(OBJ_DIR)/test_3d.o
	mkdir -p $(BIN_DIR)
	$(CC) $^ $(LDFLAGS) -o $@
